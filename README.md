...
## Описание
Этот проект является учебным и предназначен для демонстрации навыков работы с технологиями, такими как Spring Boot, REST API, кэширование, интеграция с Telegram-ботом и др. 

Разработанный сервис предоставляет персонализированные рекомендации банковских продуктов на основе анализа транзакций клиентов. Включает в себя REST API и Telegram-бот для удобного взаимодействия с пользователями.
