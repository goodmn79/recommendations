...
class Invest500QueruSetTest {
    ...
    void setUp() {
        ...
        invest500 = mock(Recommend.class);
    ...
    void validateRecommendationRule_whenAllRulesFollowed_shouldReturnOptionalWithCorrectRecommendations() {
        ...
        when(recommendRepository.findByName(recommendationName)).thenReturn(Optional.of(invest500));
        ...
        Optional<Recommend> actualOption = invest500RuleSet.validateRecommendationRule(userId);
