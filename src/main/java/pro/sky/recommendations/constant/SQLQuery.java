...
public final class SQLQuery {
    ...
    public static final  String SAVE_DYNAMIC_RULE_SQL = "INSERT INTO DYNAMIC_RULES (ID, PRODUCT_ID, SPECIFICATION) VALUES (?, ?, ?)";
    public static final  String SAVE_QUERY_SQL = "INSERT INTO QUERIES(ID, DYNAMIC_RULE_ID, QUERY, NEGATE)VALUES (?, ?, ?, ?)";
    public static final String FIND_ALL_QUERIES_BY_DYNAMIC_RULE_ID_SQL="SELECT * FROM QUERIES WHERE DYNAMIC_RULE_ID = ?";
