...
public class UserService {
     ...
     * <br>Метод проверяет, существует ли пользователь с данным идентификатором в базе данных.
     *
     ...
     * <br>Метод находит пользователей, чьи имена содержат заданное ключевое слово.
     *
