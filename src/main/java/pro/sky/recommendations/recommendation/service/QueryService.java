...
public class QueryService {
     ...
     * <br>Метод сохраняет все запросы (правила) для указанной рекомендации.
     *
     ...
     * <br>Если правила не найдены, выбрасывается исключение {@link RecommendationRuleNotExistException}.
     *
